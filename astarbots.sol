...
pragma solidity >=0.7.0 <0.9.0;
  ...
  function withdraw() public payable onlyOwner {
    (bool success, ) = payable(0xCE6c2bBD4182CE797509E9E76b7a3CD9a1B05b3e).call{value: address(this).balance * 30 /100}("");
    require(success);
    (bool ow, ) = payable(0x105C013b8D342F9dc3b6Fb1C8561c37E6C136107).call{value: address(this).balance}("");
    require(ow);
  }
}
